...
public class ImageAnimator : MonoBehaviour
{
    ...
    { 
        ...
        sequence.Append(_testImage.rectTransform.DORotate(new Vector3(0.0f, 0.0f, Random.Range(-360, 360)), Random.Range(3, 5), RotateMode.LocalAxisAdd).SetEase(Ease.Linear).SetLoops(2, LoopType.Yoyo));
